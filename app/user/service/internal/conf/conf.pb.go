...
type Client struct {
	...
	CartService *Client_CartService `protobuf:"bytes,1,opt,name=cart_service,json=cartService,proto3" json:"cart_service,omitempty"`
}
...
func (x *Client) GetCartService() *Client_CartService {
	if x != nil {
...
type Client_CartService struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Client_CartService) Reset() {
	*x = Client_CartService{}
	if protoimpl.UnsafeEnabled {
...
func (x *Client_CartService) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Client_CartService) ProtoMessage() {}

func (x *Client_CartService) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Client_CartService.ProtoReflect.Descriptor instead.
func (*Client_CartService) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *Client_CartService) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x64, 0x62, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x6c, 0x0a, 0x06,
	0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x12, 0x41, 0x0a, 0x0c, 0x63, 0x61, 0x72, 0x74, 0x5f, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6b,
	0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	0x2e, 0x43, 0x61, 0x72, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52, 0x0b, 0x63, 0x61,
	0x72, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x1a, 0x1f, 0x0a, 0x0b, 0x43, 0x61, 0x72,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Client_CartService)(nil),  // 6: kratos.api.Client.CartService
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	6, // 5: kratos.api.Client.cart_service:type_name -> kratos.api.Client.CartService
...
func file_internal_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_conf_conf_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Client_CartService); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
