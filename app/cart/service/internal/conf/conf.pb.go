...
type Client struct {
	...
	ProductService *Client_ProductService `protobuf:"bytes,1,opt,name=product_service,json=productService,proto3" json:"product_service,omitempty"`
}
...
func (x *Client) GetProductService() *Client_ProductService {
	if x != nil {
...
type Client_ProductService struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Client_ProductService) Reset() {
	*x = Client_ProductService{}
	if protoimpl.UnsafeEnabled {
...
func (x *Client_ProductService) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Client_ProductService) ProtoMessage() {}

func (x *Client_ProductService) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Client_ProductService.ProtoReflect.Descriptor instead.
func (*Client_ProductService) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *Client_ProductService) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Client_ProductService)(nil), // 6: kratos.api.Client.ProductService
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	6, // 5: kratos.api.Client.product_service:type_name -> kratos.api.Client.ProductService
...
func file_internal_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_conf_conf_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Client_ProductService); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
