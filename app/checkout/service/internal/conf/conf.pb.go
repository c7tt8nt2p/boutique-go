...
type Client struct {
	...
	AuthService    *Client_ClientService `protobuf:"bytes,1,opt,name=auth_service,json=authService,proto3" json:"auth_service,omitempty"`
	CartService    *Client_ClientService `protobuf:"bytes,2,opt,name=cart_service,json=cartService,proto3" json:"cart_service,omitempty"`
	ProductService *Client_ClientService `protobuf:"bytes,3,opt,name=product_service,json=productService,proto3" json:"product_service,omitempty"`
}
...
func (x *Client) GetAuthService() *Client_ClientService {
	if x != nil {
...
func (x *Client) GetCartService() *Client_ClientService {
	if x != nil {
...
func (x *Client) GetProductService() *Client_ClientService {
	if x != nil {
		return x.ProductService
	}
	return nil
}
...
type Client_ClientService struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Client_ClientService) Reset() {
	*x = Client_ClientService{}
	if protoimpl.UnsafeEnabled {
...
func (x *Client_ClientService) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Client_ClientService) ProtoMessage() {}

func (x *Client_ClientService) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Client_ClientService.ProtoReflect.Descriptor instead.
func (*Client_ClientService) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *Client_ClientService) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x22, 0xa0, 0x01, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x2b, 0x0a,
	...
	0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xa4, 0x01, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35,
	...
	0x61, 0x62, 0x61, 0x73, 0x65, 0x1a, 0x65, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73,
	...
	,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Client_ClientService)(nil), // 6: kratos.api.Client.ClientService
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	6, // 5: kratos.api.Client.auth_service:type_name -> kratos.api.Client.ClientService
	6, // 6: kratos.api.Client.cart_service:type_name -> kratos.api.Client.ClientService
	6, // 7: kratos.api.Client.product_service:type_name -> kratos.api.Client.ClientService
...
func file_internal_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_conf_conf_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Client_ClientService); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
