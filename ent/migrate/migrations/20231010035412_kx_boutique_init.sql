...
-- Create "auths" table
CREATE TABLE "auths" ("id" uuid NOT NULL, "password_hash" character varying NOT NULL, "user_id" uuid NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "auths_users_auth" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
-- Create index "auths_user_id_key" to table: "auths"
...
-- Add pk ranges for ('auths'),('carts'),('cart_items'),('products'),('users') tables
INSERT INTO "ent_types" ("type") VALUES ('auths'), ('carts'), ('cart_items'), ('products'), ('users');
