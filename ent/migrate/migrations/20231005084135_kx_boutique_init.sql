...
-- Create "users" table
CREATE TABLE "users" ("id" uuid NOT NULL, "name" character varying NULL, "age" character varying NOT NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, PRIMARY KEY ("id"));
