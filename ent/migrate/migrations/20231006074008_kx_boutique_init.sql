...
-- Create "users" table
CREATE TABLE "users" ("id" uuid NOT NULL, "name" character varying NOT NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, PRIMARY KEY ("id"));
...
-- Create "carts" table
CREATE TABLE "carts" ("id" uuid NOT NULL, "qty" bigint NOT NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "product_id" uuid NOT NULL, "cart_id" uuid NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "carts_products_carts" FOREIGN KEY ("product_id") REFERENCES "products" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION, CONSTRAINT "carts_user_cart_carts" FOREIGN KEY ("cart_id") REFERENCES "user_cart" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
