...
func (pc *ProductCreate) AddCartItemIDs(ids ...uuid.UUID) *ProductCreate {
	pc.mutation.AddCartItemIDs(ids...)
	return pc
}

// AddCartItem adds the "cart_item" edges to the CartItem entity.
func (pc *ProductCreate) AddCartItem(c ...*CartItem) *ProductCreate {
...
func (pc *ProductCreate) createSpec() (*Product, *sqlgraph.CreateSpec) {
	...
	if nodes := pc.mutation.CartItemIDs(); len(nodes) > 0 {
