...
type UserEdges struct {
	...
	UserCart *UserCart `json:"user_cart,omitempty"`
...
func (e UserEdges) UserCartOrErr() (*UserCart, error) {
	if e.loadedTypes[0] {
		if e.UserCart == nil {
...
// QueryUserCart queries the "user_cart" edge of the User entity.
func (u *User) QueryUserCart() *UserCartQuery {
	return NewUserClient(u.config).QueryUserCart(u)
}
