...
func (e ProductEdges) CartItemOrErr() ([]*CartItem, error) {
	if e.loadedTypes[0] {
...
// QueryCartItem queries the "cart_item" edge of the Product entity.
func (pr *Product) QueryCartItem() *CartItemQuery {
	return NewProductClient(pr.config).QueryCartItem(pr)
}
