...
// The UserCartFunc type is an adapter to allow the use of ordinary
// function as UserCart mutator.
type UserCartFunc func(context.Context, *generated.UserCartMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f UserCartFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.UserCartMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.UserCartMutation", m)
}
