...
func (pu *ProductUpdate) AddCartIDs(ids ...uuid.UUID) *ProductUpdate {
...
func (pu *ProductUpdate) RemoveCartIDs(ids ...uuid.UUID) *ProductUpdate {
...
// AddCartIDs adds the "carts" edge to the Cart entity by IDs.
func (puo *ProductUpdateOne) AddCartIDs(ids ...uuid.UUID) *ProductUpdateOne {
...
// RemoveCartIDs removes the "carts" edge to Cart entities by IDs.
func (puo *ProductUpdateOne) RemoveCartIDs(ids ...uuid.UUID) *ProductUpdateOne {
