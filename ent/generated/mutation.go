...
type CartMutation struct {
	...
	owner_cart_id           *uuid.UUID
	clearedowner_cart_id    bool
	owner_product_id        *uuid.UUID
	clearedowner_product_id bool
	done                    bool
...
func (m *CartMutation) SetOwnerCartIDID(id uuid.UUID) {
	m.owner_cart_id = &id
}

// ClearOwnerCartID clears the "owner_cart_id" edge to the UserCart entity.
func (m *CartMutation) ClearOwnerCartID() {
	m.clearedowner_cart_id = true
	m.clearedFields[cart.FieldCartID] = struct{}{}
}

// OwnerCartIDCleared reports if the "owner_cart_id" edge to the UserCart entity was cleared.
func (m *CartMutation) OwnerCartIDCleared() bool {
	return m.clearedowner_cart_id
}

// OwnerCartIDID returns the "owner_cart_id" edge ID in the mutation.
func (m *CartMutation) OwnerCartIDID() (id uuid.UUID, exists bool) {
	if m.owner_cart_id != nil {
		return *m.owner_cart_id, true
	}
	return
}

// OwnerCartIDIDs returns the "owner_cart_id" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// OwnerCartIDID instead. It exists only for internal usage by the builders.
func (m *CartMutation) OwnerCartIDIDs() (ids []uuid.UUID) {
	if id := m.owner_cart_id; id != nil {
		ids = append(ids, *id)
	}
	return
}

// ResetOwnerCartID resets all changes to the "owner_cart_id" edge.
func (m *CartMutation) ResetOwnerCartID() {
	m.owner_cart_id = nil
	m.clearedowner_cart_id = false
}

// SetOwnerProductIDID sets the "owner_product_id" edge to the Product entity by id.
func (m *CartMutation) SetOwnerProductIDID(id uuid.UUID) {
	m.owner_product_id = &id
}

// ClearOwnerProductID clears the "owner_product_id" edge to the Product entity.
func (m *CartMutation) ClearOwnerProductID() {
	m.clearedowner_product_id = true
	m.clearedFields[cart.FieldProductID] = struct{}{}
}

// OwnerProductIDCleared reports if the "owner_product_id" edge to the Product entity was cleared.
func (m *CartMutation) OwnerProductIDCleared() bool {
	return m.clearedowner_product_id
}

// OwnerProductIDID returns the "owner_product_id" edge ID in the mutation.
func (m *CartMutation) OwnerProductIDID() (id uuid.UUID, exists bool) {
	if m.owner_product_id != nil {
		return *m.owner_product_id, true
	}
	return
}

// OwnerProductIDIDs returns the "owner_product_id" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// OwnerProductIDID instead. It exists only for internal usage by the builders.
func (m *CartMutation) OwnerProductIDIDs() (ids []uuid.UUID) {
	if id := m.owner_product_id; id != nil {
		ids = append(ids, *id)
	}
	return
}

// ResetOwnerProductID resets all changes to the "owner_product_id" edge.
func (m *CartMutation) ResetOwnerProductID() {
	m.owner_product_id = nil
	m.clearedowner_product_id = false
}
...
func (m *CartMutation) AddedEdges() []string {
	...
	if m.owner_cart_id != nil {
		edges = append(edges, cart.EdgeOwnerCartID)
	}
	if m.owner_product_id != nil {
		edges = append(edges, cart.EdgeOwnerProductID)
	}
	return edges
}
...
func (m *CartMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case cart.EdgeOwnerCartID:
		if id := m.owner_cart_id; id != nil {
			return []ent.Value{*id}
		}
	case cart.EdgeOwnerProductID:
		if id := m.owner_product_id; id != nil {
			return []ent.Value{*id}
		}
	}
...
func (m *CartMutation) ClearedEdges() []string {
	edges := make([]string, 0, 2)
	if m.clearedowner_cart_id {
		edges = append(edges, cart.EdgeOwnerCartID)
	}
	if m.clearedowner_product_id {
		edges = append(edges, cart.EdgeOwnerProductID)
	}
	return edges
}
...
func (m *ProductMutation) AddCartIDs(ids ...uuid.UUID) {
	if m.carts == nil {
...
func (m *ProductMutation) RemoveCartIDs(ids ...uuid.UUID) {
...
func (m *ProductMutation) RemovedCartsIDs() (ids []uuid.UUID) {
...
// SetUserCartID sets the "user_cart" edge to the UserCart entity by id.
func (m *UserMutation) SetUserCartID(id uuid.UUID) {
	m.user_cart = &id
}

// ClearUserCart clears the "user_cart" edge to the UserCart entity.
func (m *UserMutation) ClearUserCart() {
	m.cleareduser_cart = true
}

// UserCartCleared reports if the "user_cart" edge to the UserCart entity was cleared.
func (m *UserMutation) UserCartCleared() bool {
	return m.cleareduser_cart
}

// UserCartID returns the "user_cart" edge ID in the mutation.
func (m *UserMutation) UserCartID() (id uuid.UUID, exists bool) {
	if m.user_cart != nil {
...
func (m *UserMutation) UserCartIDs() (ids []uuid.UUID) {
...
func (m *UserMutation) ResetUserCart() {
	m.user_cart = nil
...
func (m *UserMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.user_cart != nil {
		edges = append(edges, user.EdgeUserCart)
	}
	return edges
}
...
// AddCartIDs adds the "carts" edge to the Cart entity by ids.
func (m *UserCartMutation) AddCartIDs(ids ...uuid.UUID) {
	if m.carts == nil {
		m.carts = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
...
// ClearCarts clears the "carts" edge to the Cart entity.
func (m *UserCartMutation) ClearCarts() {
	m.clearedcarts = true
}

// CartsCleared reports if the "carts" edge to the Cart entity was cleared.
func (m *UserCartMutation) CartsCleared() bool {
	return m.clearedcarts
}

// RemoveCartIDs removes the "carts" edge to the Cart entity by IDs.
func (m *UserCartMutation) RemoveCartIDs(ids ...uuid.UUID) {
	if m.removedcarts == nil {
		m.removedcarts = make(map[uuid.UUID]struct{})
	}
	for i := range ids {
...
// RemovedCarts returns the removed IDs of the "carts" edge to the Cart entity.
func (m *UserCartMutation) RemovedCartsIDs() (ids []uuid.UUID) {
	for id := range m.removedcarts {
		ids = append(ids, id)
	}
	return
...
// CartsIDs returns the "carts" edge IDs in the mutation.
func (m *UserCartMutation) CartsIDs() (ids []uuid.UUID) {
	for id := range m.carts {
		ids = append(ids, id)
	}
	return
...
// ResetCarts resets all changes to the "carts" edge.
func (m *UserCartMutation) ResetCarts() {
	m.carts = nil
	m.clearedcarts = false
	m.removedcarts = nil
}
